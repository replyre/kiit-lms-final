...
const StudentAssignmentSectionCourse = () => {
  ...
  if (error) return <div className="text-red-500 dark:text-red-400 p-4 bg-white dark:bg-gray-800 rounded-lg">{error}</div>;
  if (!assignments || assignments.length === 0)
    return <div className="p-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg">No assignments found.</div>;
      ...
      <div className="w-1/4 bg-gray-50 dark:bg-gray-800 p-4 border-r border-gray-200 dark:border-gray-600 min-h-screen">
        <div className="flex items-center mb-4">
          <button
            ...
            className="flex items-center text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white mr-3 transition-colors"
          >
            ...
            return (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {hasSubmitted && (
                    <span className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-accent1 text-xs px-2 py-1 rounded-full border border-green-200 dark:border-green-700">
                      Submitted
                    </span>
                  )}
                </div>
              ...
              <div className="col-span-2 space-y-6">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="prose prose-gray dark:prose-invert max-w-none">
                    <p className="whitespace-pre-wrap text-gray-700 dark:text-gray-300">{selectedAssignment.description}</p>
                        ...
                        <div className="mt-2 space-y-2">
                          {selectedAssignment.attachments.map((attachment) => (
                            <a
                              ...
                              className="flex items-center space-x-2 text-accent1 dark:text-accent1 hover:text-green-800 dark:hover:text-accent1 transition-colors"
                            >
                ...
                {submission ? (
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="flex items-center space-x-2 text-accent1 dark:text-accent1">
              ...
              <div className="space-y-6">
                      ...
                      submission ? (
                        <span
                          className={`px-3 py-1 rounded-full text-sm border ${
                            submission
                              ? "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-accent1 border-green-200 dark:border-green-700"
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="space-y-3">
                    <a
                      href="#"
                      className="flex items-center space-x-3 text-accent1 dark:text-accent1 hover:text-accent1 dark:hover:text-accent1 transition-colors"
                    >
                      <FileText className="h-5 w-5" />
