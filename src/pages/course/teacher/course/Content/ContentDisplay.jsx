    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="bg-gray-100 p-4 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <button
            onClick={() => onEdit(courseID, moduleId, content)}
            className="px-4 py-2 bg-yellow-100 text-yellow-800 hover:bg-yellow-200 rounded-lg flex items-center text-sm font-medium shadow-sm transition-all"
          >
            Edit
          </button>
          <button
            className="p-2 hover:bg-gray-300 rounded text-red-500"
            onClick={() => onDelete(courseID, moduleId, content._id)}
          >
            <Trash2 size={18} />
          </button>
        </div>
      ...
      <div className="flex-1 overflow-auto">{renderContentBody()}</div>

      <div className="p-4 border-t flex justify-between items-center">
        <div className="text-sm text-gray-500">Added on {getContentDate()}</div>
        {content.description && (
