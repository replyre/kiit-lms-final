...
const AnnouncementManagement = ({ courseID }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingAnnouncement) {
        // Pass courseID and announcementID to updateAnnouncement
  ...
  const handleDelete = async (announcementID) => {
    if (window.confirm("Are you sure you want to delete this announcement?")) {
      try {
        // Pass courseID and announcementID to deleteAnnouncement
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8">
      ...
      {/* Form and Announcements Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Form Section - Show when editing or creating */}
        {showForm && (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-tertiary/10 overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-tertiary/10">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 bg-primary text-white rounded-xl hover:bg-primary/90 transition-all duration-200 shadow-sm flex items-center"
                  >
      ...
      <div className="flex items-start p-5 rounded-xl bg-primary/5 border border-primary/20 mt-6">
        ...
        <div>
          <p className="text-secondary font-medium mb-1">About Announcements</p>
